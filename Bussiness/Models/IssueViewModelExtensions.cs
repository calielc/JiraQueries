...
namespace JiraQueries.Bussiness.Models {
    public static class IssueViewModelExtensions {
        public static void CoptyTo(this IssueViewModel issueViewModel, ISimpleIssueSettable settable) {
            ...
            settable.ProductionFactor = issueViewModel.CustomFields.FatorProdutizacao;
            settable.TechnologyUpdateFactor = issueViewModel.CustomFields.FatorAtualizacaoTecnologica;
